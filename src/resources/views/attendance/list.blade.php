...
@section('content')
<div class="main-shell page-attendance-list">
    <h1 class="page-heading"><span class="title">勤怠一覧</span></h1>

        <div class="month-nav">
            <a class="month-link" href="{{ route('attendance.list', ['month' => $previousMonth]) }}">← 前月</a>
            <div class="month-label">
                ...
                {{ $month->isoFormat('YYYY/MM') }}
            </div>
            <a class="month-link" href="{{ route('attendance.list', ['month' => $nextMonth]) }}">翌月 →</a>
        </div>
            ...
            <table class="attendance-table">
                ...
                <tbody>
                    @forelse ($attendances as $attendance)
                        <tr>
                            <td>{{ $attendance->workDateLabel() }}</td>
                            ...
                            <td><a class="table-link" href="{{ route('attendance.show', $attendance) }}">詳細</a></td>
                        </tr>
                    @empty
                        <tr>
